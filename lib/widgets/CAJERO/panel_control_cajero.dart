...
class PanelControlCajero extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      // Quitamos el padding del Container padre para que el LayoutBuilder mida la pantalla exacta
      child: LayoutBuilder(
        builder: (context, constraints) {
          return SingleChildScrollView(
            child: ConstrainedBox(
              // Obligamos a que el contenido mida por lo menos lo mismo que la pantalla
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // ==========================================
                      // LA MAGIA: EL SPACER EXPANDIBLE
                      // ==========================================
                      // Esto empuja todo lo que está abajo hacia el fondo de la pantalla
                      const Spacer(),
